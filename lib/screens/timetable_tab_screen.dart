...
/// Liste des enfants pour accéder à l'emploi du temps
class TimetableTabScreen extends StatefulWidget implements MainScreenChild {
  const TimetableTabScreen({super.key});

  @override
  State<TimetableTabScreen> createState() => _TimetableTabScreenState();
}
...
class _TimetableTabScreenState extends State<TimetableTabScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_isLoading) {
      return Scaffold(
        appBar: AppBar(title: Text('Emploi du temps', style: TextStyle(color: AppColors.getTextColor(isDark))), backgroundColor: AppColors.getSurfaceColor(isDark), elevation: 0),
        ...
        child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return CustomCard(
              ...
              onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (_) => TimetableScreen(childId: child.id))),
              child: ListTile(
