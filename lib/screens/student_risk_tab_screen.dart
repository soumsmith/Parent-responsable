...
/// Liste des enfants pour accéder à l'analyse « Élève en difficulté »
class StudentRiskTabScreen extends StatefulWidget implements MainScreenChild {
  const StudentRiskTabScreen({super.key});

  @override
  State<StudentRiskTabScreen> createState() => _StudentRiskTabScreenState();
}

class _StudentRiskTabScreenState extends State<StudentRiskTabScreen> {
          ...
          itemBuilder: (context, index) {
            ...
            return CustomCard(
              ...
              onTap: () => Navigator.of(context).push(
                MaterialPageRoute(builder: (_) => StudentRiskScreen(childId: child.id)),
              ),
              child: ListTile(
